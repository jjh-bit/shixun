...
def main():
    """阶段 D：模型评估 — 在独立测试集上评估全部 5 个模型"""
    os.makedirs(RESULT_DIR, exist_ok=True)

    # ======================================
    # 1. 加载测试集
    # ======================================
    test_path = os.path.join(DATA_DIR, "特征工程输出_test_15.csv")
    ...
    for model_name, model_file in MODELS.items():
        ...
        results.append([model_name, acc, precision, recall, f1, auc])
        ...
        plt.savefig(
            os.path.join(RESULT_DIR, f"{model_name}_confusion_matrix.png"),
            dpi=300,
            bbox_inches="tight"
        )
        plt.close()
    ...
    result_df.to_csv(os.path.join(RESULT_DIR, "Model_Comparison.csv"),
